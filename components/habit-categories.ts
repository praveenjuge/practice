...
const HABIT_CATEGORY_IDS = new Set<string>(
  HABIT_CATEGORIES.map((item) => item.id)
);
...
export const getHabitCategory = (id?: string | null): HabitCategory =>
  ...
  // biome-ignore lint/style/noNonNullAssertion: <dont know>
